...
// si buscamos con id --> #, para class --> .
document.querySelector("#createdBy").innerHTML += " Melina Reynoso"

// var nombre = " Melina Reynoso"
...
function buildToDo(todo, index) {
  ...
  document.checkbox.type("checkbox")  
  //checkbox.type = 'checkbox'
  
  checkbox.setAttribute("class",index)
  //checkbox.id = index
...
function addToDo() {
  ...
  // paso 3 accedo al input y le digo que ahora su valor sea un str vacio
